...
wtype = "island" -- normal/nether/island

-- do not touch
if wtype == "normal" then
x1, y1 = 100, 60
elseif wtype == "nether" then
x1, y1 = 150, 150
elseif wtype == "island" then
x1, y1 = 0, 199
end

SendPacket(2,"action|input|\ntext|`^Sc Cek Magplant Stock V2 By `bSekrip Cepees")
rnmag = 1
totalblock = 0
...
result = [[
set_default_color||
add_label_with_icon|big|`cCek Magplant Stock V2|left|5638|
